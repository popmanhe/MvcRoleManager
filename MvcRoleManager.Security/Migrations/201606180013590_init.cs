    ...
    public partial class init : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Actions", t => t.RoleId, cascadeDelete: true)
                .ForeignKey("dbo.AspNetRoles", t => t.ActionId, cascadeDelete: true)
                .Index(t => t.RoleId)
                .Index(t => t.ActionId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ActionRoles", "ActionId", "dbo.AspNetRoles");
            DropForeignKey("dbo.ActionRoles", "RoleId", "dbo.Actions");
